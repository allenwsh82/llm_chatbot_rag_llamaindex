        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    # Using llama 3.1 on Ollama framework which is embedded together in LlamaIndex
...
with col1:
    st.header(f"AI ChatBot with RAG using Llama-3.1-8B with Intel Xeon 4th Gen 8480")
